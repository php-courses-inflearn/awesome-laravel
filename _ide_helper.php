 ...
 */
     ...
     */ 
        ...
        {
                        return \Illuminate\Http\Client\Factory::api($token);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \App\Providers\SessionServiceProvider::boot()
         * @param \App\Enums\Provider $provider
         * @param string|null $email
         * @static 
         */ 
        public static function socialite($provider, $email = null)
        {
                        return \Illuminate\Session\Store::socialite($provider, $email);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function socialiteMissingAll()
        {
                        return \Illuminate\Session\Store::socialiteMissingAll();
        }
...
')
     ...
     */ 
         ...
         * 
         *
         * @see \App\Models\Post::registerSearchableMacros()
         * @static 
         */ 
         ...
         * 
         *
         * @see \App\Providers\PaginateServiceProvider::boot()
         * @param int $perPage
         * @param int $currentPage
         * @param array $options
         * @static 
         */ 
        public static function paginate($perPage, $currentPage, $options = [])
        {
                        return \Illuminate\Support\Collection::paginate($perPage, $currentPage, $options);
        }
